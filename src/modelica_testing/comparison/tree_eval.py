...
def evaluate_spec(
    ...
    shared_ref_time: Optional[np.ndarray],
    ...
    if isinstance(spec, LeafSpec):
        return _evaluate_leaf(
            spec, var_results_by_name, ref_vars_by_name,
            shared_ref_time, base_tolerance,
        )

    children = [
        evaluate_spec(
            c, var_results_by_name, ref_vars_by_name,
            shared_ref_time, base_tolerance,
        )
...
def _evaluate_leaf(
    ...
    ref_var = ref_vars_by_name.get(leaf.variable)
